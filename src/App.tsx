...
function App() {
  ...
  return (
    <div style={{
      ...
      <AnimatePresence>
        {!selectedNode && !showSplash && (
          <>
            ...
            >
              {[
                { href: 'https://www.instagram.com/bydevansh', label: 'Instagram', color: '#e1306c', icon: (
                ...
                { href: 'https://leetcode.com/u/Devansh1974/', label: 'LeetCode', color: '#ffa116', icon: (
                ...
                { href: 'https://x.com/Dev_Developerr', label: 'X.com', color: '#e7e9ea', icon: (
                ...
                { href: 'https://www.youtube.com/@bydevansh', label: 'YouTube', color: '#ff0000', icon: (
      ...
      ===================================================================== */}
      {!selectedNode && !showSplash && (
        <main style={homeScrollWrapperStyle}>
          ...
          <section id="about-section" style={aboutSectionStyle}>
            ...
            <div style={aboutContentStyle}>
              ...
              <div style={aboutBioBoxStyle}>
                ...
                <h2 style={aboutBioTitleStyle}>Full-Stack Developer • AI Engineer • Growth Marketer</h2>
                <p style={aboutBioDescStyle}>
                  I build high-performance full-stack web applications and intelligent AI engines. As the Secretary of the Microsoft Azure Developer Community at Alliance University and the 1st Place winner at the Code Sangram Hackathon (out of 100+ teams), I love pushing the boundaries of technology.
                </p>
                <p style={aboutBioDescStyle}>
                  Beyond software engineering, I specialize in digital marketing—running high-converting Meta Ads and Google Ads campaigns to drive growth. I bridge complex backend systems, responsive user interfaces, and data-driven marketing pipelines. Select any galaxy node above to explore my world.
                </p>
              </div>
          ...
          <section id="contact-section" style={contactSectionStyle}>
            {/* Ambient bg */}
            <div style={{
              position: 'absolute', inset: 0,
              ...
              <div style={{ ...contactBodyStyle, justifyContent: 'center' }}>
                ...
                <div style={{ ...contactFormColStyle, flex: '1 1 100%', maxWidth: '640px', margin: '0 auto' }}>
                  ...
                  >
                    ...
                    <input type="text" name="name" aria-label="Your Name" placeholder="Your Name" required style={formInputStyle} />
                    <input type="email" name="email" aria-label="Your Email" placeholder="Your Email" required style={formInputStyle} />
                    <textarea name="message" aria-label="Write your message here" placeholder="Write your message here..." required rows={5} style={formTextareaStyle} />
